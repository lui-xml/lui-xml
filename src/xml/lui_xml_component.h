/**
 * @file lui_xml_component.h
 *
 */

#ifndef LUI_XML_COMPONENT_H
#define LUI_XML_COMPONENT_H
 ...
 * `lui_xml_register_component_from_data()` or `lui_xml_register_component_from_file()`
