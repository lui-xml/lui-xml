/**
 * @file lui_xml_style.h
 *
 */

#ifndef LUI_XML_STYLE_H
#define LUI_XML_STYLE_H
...
typedef struct _lui_xml_style_t {
    const char * name;
...
/**
 * Find a style by name which was added by `lui_xml_register_style`
 ...
 */
lui_xml_style_t * lui_xml_get_style_by_name(lui_xml_component_scope_t * scope, const char * name);
