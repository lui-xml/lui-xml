/**
 * @file lui_xml_widget.h
 *
 */

#ifndef LUI_XML_WIDGET_H
#define LUI_XML_WIDGET_H
...
typedef  void * (*lui_xml_widget_create_cb_t)(lui_xml_parser_state_t * state, const char ** parent_attrs);
typedef  void (*lui_xml_widget_apply_cb_t)(lui_xml_parser_state_t * state, const char ** parent_attrs);

typedef struct _lv_widget_processor_t {
    const char * name;
    lui_xml_widget_create_cb_t create_cb;
    lui_xml_widget_apply_cb_t apply_cb;
 ...
 */
lv_result_t lui_xml_register_widget(const char * name, lui_xml_widget_create_cb_t create_cb,
                                   lui_xml_widget_apply_cb_t apply_cb);
 ...
 */
lv_widget_processor_t * lui_xml_widget_get_processor(const char * name);
 ...
 */
lv_widget_processor_t * lui_xml_widget_get_extended_widget_processor(const char * extends);
